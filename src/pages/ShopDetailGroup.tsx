...
const ShopDetailGroup: React.FC = () => {
            ...
            <div className="row">
                <div className="col-lg-12">
                    <div className="navigator-breadcrumb-wrapper">
                        ...
                        <a className="#" href="index-2.html">Beverage</a>
                        <i className="fa-solid fa-chevron-right"></i>
                        <a className="current" href="index-2.html">2L Mum Water</a>
                    </div>
                </div>
            </div>
        </div>
                  ...
                  <div className="details-product-area">
                    ...
                    <div className="contents">
                      ...
                      <div className="product-bottom-action">
                          <div className="number-counter-product-detrails-group">
                            <div className="cart-edits">
                              ...
                              <h4 className="title">Pecanera Brasil</h4>
                              <h4 className="title-price">$200.00</h4>
                            </div>
                            <div className="cart-edits">
                              <div className="quantity-edit action-item">
                                <button className="button">
                              ...
                              <h4 className="title">Nestle Cerelac</h4>
                              <h4 className="title-price">$200.00</h4>
                            </div>
                            <div className="cart-edits">
                              <div className="quantity-edit action-item">
                              ...
                              <h4 className="title">Peysan Full Fat Fresh </h4>
                              <h4 className="title-price">$200.00</h4>
                            </div>
                          </div>
                    ...
                    <div className="details-row-2">
                      ...
                      <div className="right">
                        ...
                        <p className="mb--25">
                          ...
                          amet, ante. ibero sit amet quam egestas semperAenean
               ...
               {activeTab === 'profile' && (
                <div
                  ...
                  <div className="single-tab-content-shop-details">
                    ...
                    <p className="note">
                      <span>Note:</span> Product delivery duration may vary due
                      to product availability in stock.
                    </p>
                  </div>
                </div>
               )}
          ...
          <div className="col-lg-12">
            <div className="category-area-main-wrapper-one">
              <Swiper
                ...
                breakpoints={{
                    0: { slidesPerView: 1, spaceBetween: 12 },     // For small screens
                    480: { slidesPerView: 2, spaceBetween: 12 },   // For medium screens
                    840: { slidesPerView: 3, spaceBetween: 16 },   // For larger screens
                  }}
...
export default ShopDetailGroup;