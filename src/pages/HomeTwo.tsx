            ...
            <div className="banner-area-two-start">
              <div className="banner-bg-iamge-area bg_banner-2 bg_image">
                <div className="content">
                  ...
                  <p className="disc">
                    We have prepared special discounts for you on grocery products. Dont <br /> miss these opportunities...
                  </p>
...
<div className="weekly-best-seller-area rts-section-gap bg_light-1">
      <div className="container-2">
        ...
        <div className="row g-4 mt--10">
          <div className="col-xl-2 col-md-3 col-md-4 col-sm-6 col-12">
            <div className="weekly-best-seller-item-single">
              <a href="shop-details.html" className="thumbanil">
                <img src="images/best-seller/01.png" alt="seller" />
              ...
              <div className="inner">
                <a href="shop-details.html">
                  <h4 className="title">Super Fresh Meat</h4>
                </a>
                <h6 className="price">$36.00</h6>
              </div>
            </div>
          </div>
          <div className="col-xl-2 col-md-3 col-md-4 col-sm-6 col-12">
            <div className="weekly-best-seller-item-single">
              <a href="shop-details.html" className="thumbanil">
                <img src="images/best-seller/02.png" alt="seller" />
                <div className="action-share-option">
                  <div
                    className="single-action openuptip message-show-action"
                    data-data-flow="up"
          ...
          <div className="col-xl-2 col-md-3 col-md-4 col-sm-6 col-12">
            <div className="weekly-best-seller-item-single">
              <a href="shop-details.html" className="thumbanil">
                <img src="images/best-seller/03.png" alt="seller" />
                <div className="action-share-option">
                  <div
                    className="single-action openuptip message-show-action"
                    data-data-flow="up"
          ...
          <div className="col-xl-2 col-md-3 col-md-4 col-sm-6 col-12">
            <div className="weekly-best-seller-item-single">
              <a href="shop-details.html" className="thumbanil">
                <img src="images/best-seller/04.png" alt="seller" />
                <div className="action-share-option">
                  <div
                    className="single-action openuptip message-show-action"
                    data-data-flow="up"
          ...
          <div className="col-xl-2 col-md-3 col-md-4 col-sm-6 col-12">
            <div className="weekly-best-seller-item-single">
              <a href="shop-details.html" className="thumbanil">
                <img src="images/best-seller/05.png" alt="seller" />
                <div className="action-share-option">
                  <div
                    className="single-action openuptip message-show-action"
                    data-data-flow="up"
          ...
          <div className="col-xl-2 col-md-3 col-md-4 col-sm-6 col-12">
            <div className="weekly-best-seller-item-single">
              <a href="shop-details.html" className="thumbanil">
                <img src="images/best-seller/06.png" alt="seller" />
                <div className="action-share-option">
                  <div
                    className="single-action openuptip message-show-action"
                    data-data-flow="up"
            ...
            <div className="row">
                <div className="col-lg-12">
                    <div className="offer-area-main-wrapper">
                        ...
                        <p className="disc">
                            We have prepared special discounts for you on grocery products. <br></br>  Dont miss these opportunities...
                        </p>
                        <div className="offer-iamge">
                            <img src="images/offer/01.png" alt="offer-area"/>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="col-lg-6 col-md-6 col-sm-12 col-12">
                  <div className="single-shopping-card-one deals-of-day new-deal-offer-border-right">
                    ...
                    <div className="body-content">
                      ...
                      <a href="shop-details.html">
                        <h4 className="title">Gerber Superfood Hearts Puffed Multigrain Snack</h4>
                      </a>
                      <span className="availability">500g Pack</span>
                      <div className="price-area">
                        <span className="current">$36.00</span>
                ...
                <div className="col-lg-6 col-md-6 col-sm-12 col-12">
                  <div className="single-shopping-card-one deals-of-day">
                    ...
                    <div className="body-content">
                      ...
                      <a href="shop-details.html">
                        <h4 className="title">John Soules Foods, Fully Cooked, Steak Fajitas...</h4>
                      </a>
                      <span className="availability">500g Pack</span>
                      <div className="price-area">
                        <span className="current">$36.00</span>
            ...
            <div className="col-lg-12">
              <div className="copyright-arae-two-wrapper">
                ...
                <div className="payment-processw-area">
                  ...
                  <img src="images/payment/04.png" alt="payment" />
                </div>
              </div>
            </div>
          </div>
